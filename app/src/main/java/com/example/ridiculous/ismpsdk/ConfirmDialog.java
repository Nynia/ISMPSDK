...
public class ConfirmDialog extends Dialog {
    ...
    public static class Builder {
        ...
        // 对话框按钮监听事件
        private DialogInterface.OnCancelListener backButtonClickListener;

        private DialogInterface.OnDismissListener confirmButtonClickListener;
         ...
         * @return
         */
        public Builder setBackButton(int backButtonText, DialogInterface.OnCancelListener listener) {
         ...
         * @return
         */
        public Builder setBackButton(String backButtonText, DialogInterface.OnCancelListener listener) {
         ...
         * @return
         */
        public Builder setConfirmButton(int confirmButtonText, DialogInterface.OnDismissListener listener) {
         ...
         * @return
         */
        public Builder setConfirmButton(String confirmButtonText, DialogInterface.OnDismissListener listener) {
                ...
                if (backButtonClickListener != null) {
                    bckButton.setOnClickListener(new View.OnClickListener() {
                        public void onClick(View v) {
                            backButtonClickListener.onCancel(dialog);
                        }
                    });
                }
            } else {
            ...
            if (confirmButtonText != null) {
                ...
                if (confirmButtonClickListener != null) {
                    cfmButton.setOnClickListener(new View.OnClickListener() {
                        public void onClick(View v) {
                            confirmButtonClickListener.onDismiss(dialog);
                        }
                    });
                }
            } else {
